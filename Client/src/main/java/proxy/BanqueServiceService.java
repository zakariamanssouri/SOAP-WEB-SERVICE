 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://ws/", wsdlLocation = "http://0.0.0.0:8888/WS/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0.0.0.0:8888/WS/BanqueService?wsdl");
